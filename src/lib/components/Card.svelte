<div class="col-span-12 md:col-span-6 lg:col-span-4 md:order-1 grid gap-4 xl:gap-6 pt-20 lg:pt-36">
    <!-- Card -->
    <a class="md:order-2 relative before:absolute before:inset-0 before:z-10 before:border before:border-gray-200 before:rounded-xl before:transition before:hover:border-2 before:hover:border-blue-600 before:hover:shadow-lg" href="/lists">
      <div class="relative overflow-hidden w-full h-full rounded-xl">
        <div class="p-6 flex bg-gray-800 flex-col justify-between md:min-h-[480px] text-center rounded-xl dark:border-gray-700">
          <div>
            ...
            <h3 class="text-lg md:text-xl font-semibold text-stone-50 dark:text-gray-200">
              Bevásárlás az Online Bevásárlólistával
            </h3>
            <p class="mt-2 text-stone-50">
              A weboldal ami megegyszerűsíti a bevásárlást.
            </p>
          </div>
            ...
            <ul class="flex flex-col text-left space-y-1.5">
                <li class="relative flex gap-x-4 pb-7 overflow-hidden">
                  <div class="mt-0.5 relative h-full">
                    ...
                    <svg class="w-5 h-5 text-stone-50 dark:text-gray-200" width="24" height="24" viewBox="0 0 24 24" fill="none" >
                      <path d="M16.8462 12.3462C16.8462 15.0226 14.6765 17.1923 12 17.1923C9.32354 17.1923 7.15385 15.0226 7.15385 12.3462M16.8462 12.3462C16.8462 9.6697 14.6765 7.5 12 7.5C9.32354 7.5 7.15385 9.6697 7.15385 12.3462M16.8462 12.3462H22.5M7.15385 12.3462H1.5" stroke="currentColor" stroke-linecap="round"></path>
                    </svg>
                  </div>
                  <p class="py-1.5 px-2.5 rounded-full text-xs font-medium text-gray-600 bg-white border border-gray-200 shadow-sm dark:text-gray-400 dark:bg-slate-900 dark:border-gray-700">
                    <span class="font-semibold text-gray-800 dark:text-gray-200">Lista </span>létrehozása
                  </p>
                </li>
                ...
                <li class="relative flex gap-x-4 pb-7 overflow-hidden">
                  <div class="mt-0.5 relative h-full">
                    <div class="absolute top-7 bottom-0 left-2.5 w-px h-96 -ml-px border-r border-dashed border-gray-300 dark:border-gray-600"></div>
                    <svg class="w-5 h-5 text-stone-50 dark:text-gray-200" width="24" height="24" viewBox="0 0 24 24" fill="none" >
                      <path d="M4.73077 8.90727C6.51507 8.90727 7.96154 7.4698 7.96154 5.69658C7.96154 3.92337 6.51507 2.4859 4.73077 2.4859C2.94646 2.4859 1.5 3.92337 1.5 5.69658C1.5 7.4698 2.94646 8.90727 4.73077 8.90727ZM4.73077 8.90727V15.3286M4.73077 15.3286C2.94646 15.3286 1.5 16.7661 1.5 18.5393C1.5 20.3125 2.94646 21.75 4.73077 21.75C6.51507 21.75 7.96154 20.3125 7.96154 18.5393C7.96154 16.7661 6.51507 15.3286 4.73077 15.3286ZM19.2692 15.3286C17.4849 15.3286 16.0385 16.7661 16.0385 18.5393C16.0385 20.3125 17.4849 21.75 19.2692 21.75C21.0535 21.75 22.5 20.3125 22.5 18.5393C22.5 16.7661 21.0535 15.3286 19.2692 15.3286ZM19.2692 15.3286V7.30193C19.2692 6.41532 18.546 5.69658 17.6538 5.69658L15.2308 5.69658M15.2308 8.74103V2.65214C15.2308 2.29459 14.7958 2.11553 14.5414 2.36835L11.4779 5.4128C11.3202 5.56953 11.3202 5.82364 11.4779 5.98037L14.5414 9.02482C14.7958 9.27764 15.2308 9.09858 15.2308 8.74103Z" stroke="currentColor" stroke-linecap="round"></path>
                    </svg>
                  </div>
                  <p class="py-1.5 px-2.5 rounded-full text-xs font-medium text-gray-600 bg-white border border-gray-200 shadow-sm dark:text-gray-400 dark:bg-slate-900 dark:border-gray-700">
                    <span class="font-semibold text-gray-800 dark:text-gray-200">Vennivalók</span> felvétele
                  </p>
                </li>
                ...
                <li class="relative flex gap-x-4 pb-7 overflow-hidden">
                  ...
                  <p class="py-1.5 px-2.5 rounded-full text-xs font-medium text-gray-600 bg-white border border-gray-200 shadow-sm dark:text-gray-400 dark:bg-slate-900 dark:border-gray-700">
                    <span class="font-semibold text-gray-800 dark:text-gray-200">Megvett</span> dolgok kipipálása
                  </p>
                </li>
                ...
                <li class="relative flex gap-x-4 pb-7 overflow-hidden">
                  ...
                  <p class="py-1.5 px-2.5  rounded-full text-xs font-medium text-gray-600 bg-white border border-gray-200 shadow-sm dark:text-gray-400 dark:bg-slate-900 dark:border-gray-700">
                    Megvett dolgok <span class="font-semibold text-gray-800 dark:text-gray-200"> kipipálása</span>
                  </p>
                </li>
        ...
        <div class="absolute top-1/2 -left-1/2 -z-[1] w-60 h-32 bg-gray-800 blur-[100px] -translate-y-1/2 dark:bg-violet-900/30"></div>
      </div>
    </a>
    <!-- End Card -->
