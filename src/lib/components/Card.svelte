<div class="col-span-12 md:col-span-6 lg:col-span-4 md:order-1 grid gap-4 xl:gap-6 pt-20 lg:pt-36">
	<!-- Card -->
	<a
		class="md:order-2 relative before:absolute before:inset-0 before:z-10 before:border before:border-gray-200 before:rounded-xl before:transition before:hover:border-2 before:hover:border-blue-600 before:hover:shadow-lg"
		href="/lists"
	>
		<div class="relative overflow-hidden w-full h-full rounded-xl">
			<div
				class="p-6 flex bg-gray-800 flex-col justify-between md:min-h-[480px] text-center rounded-xl dark:border-gray-700"
			>
				<div>
					<svg class="w-8 h-8 mx-auto mb-4" width="33" height="32" viewBox="0 0 33 32" fill="none">
						...
						<defs>
							<clipPath id="clip0_6991_185972">
								<rect width="32" height="32" fill="white" transform="translate(0.333313)" />
							</clipPath>
						</defs>
					</svg>
					...
					<p class="mt-2 text-stone-50">A weboldal ami megegyszerűsíti a bevásárlást.</p>
				</div>
					...
					<ul class="flex flex-col text-left space-y-1.5">
						<li class="relative flex gap-x-4 pb-7 overflow-hidden">
							<div class="mt-0.5 relative h-full">
								...
								/>
								<svg
									class="w-5 h-5 text-stone-50 dark:text-gray-200"
									width="24"
									height="24"
									viewBox="0 0 24 24"
									fill="none"
						...
						<li class="relative flex gap-x-4 pb-7 overflow-hidden">
							...
							<p
								class="py-1.5 px-2.5 rounded-full text-xs font-medium text-gray-600 bg-white border border-gray-200 shadow-sm dark:text-gray-400 dark:bg-slate-900 dark:border-gray-700"
							>
								Megvett dolgok <span class="font-semibold text-gray-800 dark:text-gray-200">
									kipipálása</span
								>
							</p>
						</li>
						...
						<li class="relative flex gap-x-4 pb-7 overflow-hidden">
							...
							<p
								class="py-1.5 px-2.5 rounded-full text-xs font-medium text-gray-600 bg-white border border-gray-200 shadow-sm dark:text-gray-400 dark:bg-slate-900 dark:border-gray-700"
							>
								<span class="font-semibold text-gray-800 dark:text-gray-200">Egyszerűbb</span> lett az
								életünk
							</p>
						</li>
					</ul>
			...
			<div
				class="absolute top-1/2 -left-1/2 -z-[1] w-60 h-32 bg-gray-800 blur-[100px] -translate-y-1/2 dark:bg-violet-900/30"
			/>
		</div>
	</a>
	<!-- End Card -->
